 ...
 * @param {String} lang
 */
export const parseThematicBlock = function (lang) {
  /**
  ...
  return {
    ...
    lineHighlights: lineHighlightTokens[1]
      ? lineHighlightTokens[1].replace(/}.*/, '')
      : null,
    fileName: Array.isArray(filenameTokens) ? filenameTokens[1] : null,
  };
};

export const TAG_NAME_REGEXP = /^<\/?([A-Za-z0-9-_]+) ?[^>]*>/;
export const getTagName = function (value) {
